...
* Note the Harbor instance has a default network of `172.18.0.0/16` and the backing Docker instance has a default network of `172.17.0.0/16`. Therefore, to use Harbor Registry, these CIDR cannot be used as VNI on the local subnet.
